...
// 0-5: Delhi, 6-10:Noida, 11-13:Gurgaon, 14-17:Chandigarh
vector<string> areas={  "Kashmere Gate ISBT", "Rajiv Chowk", "India Gate", "Connaught Place",
                        "Anand Vihar ISBT",
    ...
    while (ch!=6) {
        ...
        switch(ch) {
            ...
            case 5:
                ...
                break;
            default:
                cout<<"Thank You for using Green-Bus!\n";
                break;
        }
    }
}
